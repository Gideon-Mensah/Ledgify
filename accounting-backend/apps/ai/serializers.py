...
class ChatSerializer(serializers.Serializer):
 conversation_id=serializers.UUIDField(required=False);question=serializers.CharField(max_length=4000);parameters=serializers.JSONField(required=False,default=dict)
